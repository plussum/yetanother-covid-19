...
my $REPORT_CSVF = "$WIN_PATH/cov_daily_$MODE" . ".csv";
my $GRAPH_HTML = "$WIN_PATH/COVID-19_$MODE.html";
...
#	{ext => "$mode all-211 $TD", start_day => 0, lank =>[0, 19] , exclusion => $EXCLUSION, target => "", label_skip => 3, graph => "lines"},
	...
	{ext => "$mode 2weeks 01-10 $TD", start_day => -14, lank =>[0, 9] , exclusion => $EXCLUSION, target => "", graph => "lines"},
	{ext => "$mode 2weeks 11-20 $TD", start_day => -14, lank =>[10,19] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
	{ext => "$mode 2weeks 21-30 $TD", start_day => -14, lank =>[20,29] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
	{ext => "$mode 2weeks 31-40 $TD", start_day => -14, lank =>[30,39] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
	{ext => "$mode 2weeks 41-50 $TD", start_day => -14, lank =>[40,49] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
	{ext => "$mode 2weeks 51-60 $TD", start_day => -14, lank =>[50,59] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
	{ext => "$mode 2weeks 61-70 $TD", start_day => -14, lank =>[60,69] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
	{ext => "$mode 2weeks 71-80 $TD", start_day => -14, lank =>[70,79] , exclusion => $EXCLUSION, target => "", label_skip => 1, graph => "lines"},
