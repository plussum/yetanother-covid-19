...
my @TARGET_COUNTRY = (
	...
	{src => "tko",  title => "Toyo Keizai New Cases/Deathes",list => "東京,大阪"},
	{src => "ccse", title => "JHCCSE NEW Cases/Deathes", list => "Brazil,France,United Kingdom,Italy,Germany,South Africa,Belgium,Poland,Netherlands,Czechia,Romania,Switzerland,Portugal,Sweden"},
);
